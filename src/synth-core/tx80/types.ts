// FX parameter shapes. In the donor implementation these lived in the TX27
// foundation's audio/types module; inlined here so synth-core is fully
// self-contained. (Local modification vs donor — see PROVENANCE.md.)
